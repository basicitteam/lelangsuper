              ...
              <div class="tab-content">
                <br>
                  ...
                  <div class="tab-pane  active" id="1E">
                    ...
                    <h4 style="color:#ff9900;"><center><strong><em>Status Chat Lelang Super</em></strong></center></h4>
                      <hr>
                     <table class="table table-striped">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <td><center>Offline</center></td>
                      <td><center>Mohamad Arif Prasetyo</center></td>
                      <td>
                      <form method="POST" action="#">
                        <input type="hidden" name="id_semester" value="3">
                        <button type="submit" class="btn btn-danger pull-right"><i class="icon-edit"></i>Offline</button>
                      </form>
                      </td>
                      </tr>
                      <tr class="alert alert-warning">
                      <td><center>Online</center></td>
                      <td><center>Roger Danuarta</center></td>
                      <td>
                      <form method="POST" action="#">
                        <input type="hidden" name="id_semester" value="3">
                        <button type="submit" class="btn btn-info pull-right"><i class="icon-edit"></i>Online</button>
                      </form>
                      </td>
                      </tr>
                      <tr class="alert alert-warning">
                      <td><center>Online</center></td>
                      <td><center>Aditya</center></td>
                      <td>
                      <form method="POST" action="#">
                        <input type="hidden" name="id_semester" value="3">
                        <button type="submit" class="btn btn-info pull-right"><i class="icon-edit"></i>Online</button>
                      ...
                      <tr class="alert alert-warning">
                      <td><center>Offline</center></td>
                      <td><center>Sufiar Rizky</center></td>
                      <td>
                      <form method="POST" action="#">
                        <input type="hidden" name="id_semester" value="3">
                        <button type="submit" class="btn btn-danger pull-right"><i class="icon-edit"></i>Offline</button>
