              ...
              <div class="tab-content">
                <br>
                  ...
                  <div class="tab-pane  active" id="1E">
                    ...
                    <h4 style="color:#ff9900;"><center><strong><em>Status Testimoni Lelang Super</em></strong></center></h4>
                      <hr>
                     <table class="table table-striped">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <td><center><a href="#view" role="button" data-toggle="modal">Terima kasih . . . </a></center></td>
                      <td>
                      <form method="POST" action="#">
                        <input type="hidden"  value="3">
                        <a type="submit" class="btn btn-danger pull-left" href="#app" role="button" data-toggle="modal"><i class="icon-edit"></i>Approve</a>
                        <a type="submit" class="btn btn-danger pull-right" href="#delete" role="button" data-toggle="modal"><i class="icon-edit"></i>Delete</a>
                      </form>
                      </td>
                      </tr>
                      </tbody>
...
<form class="form-horizontal" action="<?php echo site_url('admin/setting'); ?>"  enctype="multipart/form-data">
          <div id="view" class="modal hide fade" style="display: none;box-shadow: 0px -2px 7px #ccc;background-color:#fcf8e3;">
            ...
            <div class="modal-body">
              <p style="align-text:justify;">Terima Kasih Lelang Super, saya telah memenangkan Lelang honda mobil Jazz Seharga Rp. 25.000.000,00 . ^_^</p>
            </div>
            <div class="modal-footer"style="background-color:#fcf8e3;">
              <a href="<?php echo site_url('admin/setting');?>" class="btn btn-danger" >Cancel</a>
              <a href="<?php echo site_url('admin/setting_testimoni');?>" class="btn btn-danger" >Approve</a>
          </div>
        </div>
</form>
...
<form class="form-horizontal" action="<?php echo site_url('admin/setting'); ?>"  enctype="multipart/form-data">
            ...
            <div class="modal-body">
              <h4>Testimoni ID 30209166 pada Lelang ID L121 ,berhasil di Approve! </h4>
            </div>
            <div class="modal-footer"style="background-color:#fcf8e3;">
...
<form class="form-horizontal" action="<?php echo site_url('admin/setting'); ?>"  enctype="multipart/form-data">
            ...
            <div class="modal-footer"style="background-color:#fcf8e3;">
              <a href="<?php echo site_url('admin/setting');?>" class="btn btn-danger" >Yes</a>
              <a href="<?php echo site_url('admin/setting_testimoni');?>" class="btn btn-danger" >No</a>
          </div>
        </div>
        </form>
<!-- end modal view -->
