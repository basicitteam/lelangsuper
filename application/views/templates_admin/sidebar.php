					...
					<div class="accordion" id="accordion2" style="box-shadow: 0px -2px 7px #ccc;">
					    ...
					    <div id="recentOne" class="accordion-body collapse in">
					      <div class="accordion-inner">
					        <a class="pull-left" href="#">
							    <img class="media-object" src="<?php echo base_url('assets/img/a.png'); ?>">
							  </a>
							    <p>When the original Galaxy Note came out it took the world by storm, with its unique shape and size</p>
					  ...
					  <div class="accordion-group">
					    ...
					    <div id="recentTwo" class="accordion-body collapse">
					      <div class="accordion-inner">
					       <a class="pull-left" href="#">
							    	<img class="media-object" src="<?php echo base_url('assets/img/b.png'); ?>">
							 	</a>
					        <p style="text-align: justify;">The Samsung Galaxy Ace is still being touted as a top smartphone years after its launch, so we've updated our review accordingly. Should you consider it at all despite it's super-budget price tag?</p>
				  			</p>
					      </div>
					    </div>
					  </div>
					  <div class="accordion-group">
					    ...
					    <div id="recentThree" class="accordion-body collapse">
					      <div class="accordion-inner">
					       <a class="pull-left" href="#">
							    	<img class="media-object" src="<?php echo base_url('assets/img/1.png'); ?>">
							 	</a>
					        <p style="text-align: justify;">The first Honda Jazz appeared on UK price lists in 1982. Known as the Honda City outside Europe,</p>
					      </div>
					    </div>
					  </div>
					  <a class="btn btn-warning" style="width:90%;box-shadow: 0px -2px 7px #ccc;" href="#">Barang Lainnya . . .</a>
					</div>
        ...
        pada saat diterapkan. Keterangan lebih lanjut mengenai Golden Period silahkan klik di </p>
					...
					<h4 class="btn btn-warning" style="width:90%;box-shadow: 0px -2px 7px #ccc;">Baca Selengkapnya . . .</h4>
				</div>
