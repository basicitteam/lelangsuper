...
<div class="span9 pull-left">
          ...
          <div class="tabbable tabs-left  alert alert-warning" style="border-color:#faa732;box-shadow: 0px -2px 7px #ccc;">
              <ul class="nav nav-tabs">
                ...
                <li  class="active"><a href="#1F" data-toggle="tab">Manage Voucher</a></li>
              ...
              <div class="tab-content">
                <br>
                  ...
                  <div class="tab-pane  active" id="1F">
                    <h4><center><strong><em>Input Voucher Lelang Super</em></strong></center></h4>
                    <hr>
                    <article>
                        <form class="form-horizontal" action="#" method="POST" enctype="multipart/form-data">
                          <fieldset>    
                                  <div class="control-group">
                                    <label class="control-label" for="no_voucher">No Voucher</label>
                                      <div class="controls">
                                        <input placeholder="Masukan No Voucher" type="text" class="input-large" id="no_voucher" name="no_voucher" style="width:97%">
                                      </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="nominal">Nominal Voucher</label>
                                      <div class="controls">
                                        <input placeholder="Masukan Nominal Voucher" type="text" class="input-large" id="nominal" name="nominal" style="width:97%">
                                      </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="nominal">Tanggal Input Voucher</label>
                                      <div class="controls">
                                        <input  type="date" class="input-large" id="nominal" name="nominal" style="width:97%">
                                      </div>
                                  </div>
                          </fieldset>
                        
                          <a href="<?php echo site_url("admin/setting");?>" class="btn btn-warning pull-right" >Sumbit</a>
                          <a href="<?php echo site_url("admin/setting");?>" class="btn btn-warning pull-right" >Back</a>
                        </form> 
                    </article>
